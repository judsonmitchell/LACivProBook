...
var State,
    ...
    dbName = 'CivProLaws',
    latestDbVersion = '2.10.1', //Change this on update
    pageDepth = 1,
...
init = function () {
    ...
    if (localStorage.getItem('lacivprobook-notice-2.10.1') === null){
    ...
    $('body').on('click', '.update-dismiss', function (event) {
        event.preventDefault();
        $('#update-info').remove();
        localStorage.setItem('lacivprobook-notice-2.10.1', true);
    });
};
